...
polar_bears %>%
  ...
  labs(title="Number of Males and Females by Population",
       x ="Population",
       y = "Count")
```
...
polar_bears%>%
  ...
  labs(title="Nubmer of Fasting Bears for CS By Year", 
       x="year", 
       y="Number of Bear")
```
...
polar_bears%>%
  ...
  geom_point()+
  geom_smooth(method=lm, se=F)+
  labs(title="Nubmer of Fasting Bears for SB By Year", 
       x="year", 
       y="Number of Bear")
```
...
ggmap(map1)+ 
  ...
  labs(x="Longtitude", 
       y="latitude", 
       title="Distribution of Polar Bear")
```
