...
heartrate%>%
  ...
  ggplot(aes(x=drug, y=heartrate))+geom_col()
```
...
The name of the column should be a data
...
billboard %>%
  pivot_longer(cols=starts_with("wk"), 
               names_to="week", 
               names_prefix="wk", #gets rid of wk 
               values_to="rank", 
               values_drop_na=T)
```
...
plant_data <- plant_data %>%
  pivot_longer(cols=starts_with("day"), 
               names_to="v1", 
               names_prefix="day", #gets rid of wk 
               values_to="v2", 
               values_drop_na=T)
```
